...
df_oppg3_wide %>% 
  filter(næring %in% c('Bergverksdrift', 'Helse- og omsorgstjenester', 'Jordbruk og skogbruk', 'Utvinning av råolje og naturgass, inkl. tjenester', 'Fiske, fangst og akvakultur', 'Faglig, vitenskapelig og teknisk tjenesteyting' )) %>%  
  filter(year >= 2012) %>% 
