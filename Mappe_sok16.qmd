...
df_oppg3_wide <- df_oppg3_wide %>% 
 ...
 df_oppg3_wide %>%
  ...
  ggplot(aes(x=year, y=verdi, fill=pris)) + 
...
df_oppg3_wide %>% 
  ...
  ggplot(aes(x=year, fill = pris)) + 
  geom_col(data = filter(df_oppg3_wide, pris == "Løpende"), aes(y = verdi/1000)) +
  geom_col(data = filter(df_oppg3_wide, pris == "Faste"), aes(y = verdi/1000)) +
  facet_wrap(~pris)+
  scale_fill_manual(values=c('lightcoral', 'cornflowerblue')) +
