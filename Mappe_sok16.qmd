...
df_oppg3_wide %>% 
  ...
  geom_col(data = filter(df_oppg3_wide, pris == "løpende"), aes(y = verdi/1000), position = "dodge") +
  geom_col(data = filter(df_oppg3_wide, pris == "faste"), aes(y = verdi/1000), position = "dodge") +
  facet_wrap(~pris)+
