...
graf_1 <- ggplot(df_graf_1, aes(x = year, y = log(verdi), color = næring, group = næring))+
  geom_line()+
...
graf_2 <- ggplot(df_graf_2, aes(x = year, y = log(verdi), color = næring, group = næring))+
  geom_line()+
  theme(legend.position = "")+
  scale_x_discrete(guide = guide_axis(n.dodge = 2))

plot_grid(graf_1, graf_2)
```
